...
Sprachauswahl-Seite für die Infografiken zur betrieblichen Krankenversicherung
der Kläger Group.

**Live:** https://lisa-schneider1.github.io/Betriebliche-Krankenversicherung/
...
| `bkv-<code>.webp`  | Infografik zum Anzeigen im Browser (wird verlinkt)     |
| `bkv-<code>.jpg`   | Dieselbe Grafik als JPEG zum Weiterleiten und Drucken  |
...
- Jede Sprache braucht **drei** Dateien: `bkv-<code>.webp` (Anzeige),
  `bkv-<code>.jpg` (Weiterleiten/Drucken) und `flag-<code>.webp` (Sticker).
...
3. Im Block `<div class="dl-list">` den JPEG-Link ergänzen:
   ...
   ```html
   <a href="bkv-pl.jpg" download>Polski</a>
   ```

## Bilder aufbereiten

Die Quellgrafiken sind ca. 1054 × 1492 px. Direkt exportierte PNGs sind rund
...
im.save("bkv-xx.webp", "WEBP", quality=90, method=6)
im.save("bkv-xx.jpg", "JPEG", quality=85, optimize=True,
